...
function charity_form_system_theme_settings_alter(&$form, $form_state) {
	...
	$form['hero']['hero_image'] = array(
        ...
        '#description'   => t("Please enter the file name of the Hero image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
    );
	...
	$form['involved']['involved_1_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('First Image File Name'),
        '#default_value' => theme_get_setting('involved_1_image'),
        '#description'   => t("Please enter the file name of the first image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
    );
	...
	$form['involved']['involved_2_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('Second Image File Name'),
        '#default_value' => theme_get_setting('involved_2_image'),
        '#description'   => t("Please enter the file name of the second image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
    );
	...
	$form['involved']['involved_3_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('Third Image File Name'),
        '#default_value' => theme_get_setting('involved_3_image'),
        '#description'   => t("Please enter the file name of the third image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
    );
...
// Mission Statements
	...
	$form['our_mission']['mission_1_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('First Image File Name'),
        '#default_value' => theme_get_setting('mission_1_image'),
        '#description'   => t("Please enter the file name of the first image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
    );
	...
	$form['our_mission']['mission_2_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('Second Image File Name'),
        '#default_value' => theme_get_setting('mission_2_image'),
        '#description'   => t("Please enter the file name of the second image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
    );
	...
	$form['our_mission']['mission_3_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('Third Image File Name'),
        '#default_value' => theme_get_setting('mission_3_image'),
        '#description'   => t("Please enter the file name of the third image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
    );
  ...
  $form['our_members'] = array(
        '#type' => 'fieldset', 
        '#title' => t('Our Members Images'), 
        '#weight' => 5, 
        '#collapsible' => TRUE, 
        '#collapsed' => TRUE,
  );
  $form['our_members']['members_1_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('First Image File Name'),
        '#default_value' => theme_get_setting('members_1_image'),
        '#description'   => t("Please enter the file name of the first image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
  );
  $form['our_members']['members_2_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('Second Image File Name'),
        '#default_value' => theme_get_setting('members_2_image'),
        '#description'   => t("Please enter the file name of the second image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
  );
  $form['our_members']['members_3_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('Third Image File Name'),
        '#default_value' => theme_get_setting('members_3_image'),
        '#description'   => t("Please enter the file name of the third image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
  );
  $form['our_members']['members_4_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('Fourth Image File Name'),
        '#default_value' => theme_get_setting('members_4_image'),
        '#description'   => t("Please enter the file name of the fourth image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
  );
  $form['our_members']['members_5_image'] = array(
        '#type'          => 'textfield',
        '#title'         => t('Fifth Image File Name'),
        '#default_value' => theme_get_setting('members_5_image'),
        '#description'   => t("Please enter the file name of the fifth image. Please upload the image in 'images' folder inside the 'oc' theme folder"),
  );
  ...
  $form['Logo'] = array(
        ...
        '#description'   => t("Please enter the file name of the logo. Please upload the image in 'images' folder inside the 'oc' theme folder"),
    );
